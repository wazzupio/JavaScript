...
btnEls.forEach(function (element) {
...
function handleClick(clickedButtonEvent) {
    ...
    //     hideMoreText(card);
    // }
    if (clickedButtonEvent.target.textContent === 'Подробнее') {
        showMoreText(card);
    } else if (clickedButtonEvent.target.textContent === 'Отмена') {
        hideMoreText(card);
    }
}
...
function hideMoreText(card) {
    ...
    card.wrap.childNodes.forEach(function (element) {
